...
const Kids = () => {
    return (
        <div className=' mt-15 p-10'>
            {/* BANNER */}
            <div className=''>
                <img src={kids_banner} alt="banner_mens" />
            </div>
            {/* SORT BY BUTTON */}
            ...
            <div className="flex justify-center pt-4 ">
                <button className="p-3 rounded-3xl text-md bg-gray-200 hover:bg-gray-300 transition-all duration-300 cursor-pointer">
                    Explore More
                </button>
            </div>

            <div className=' flex items-center justify-center pt-15 cursor-pointer'>
